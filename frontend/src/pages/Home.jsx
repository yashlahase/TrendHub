    ...
    <div className="bg-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 bg-white">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <button className="mt-8 md:mt-0 btn-outline text-xs px-6 py-3">View All Products</button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative h-[400px] group overflow-hidden bg-white">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
                ...
                <button className="bg-white text-primary px-8 py-3 text-xs font-bold tracking-widest hover:bg-accent hover:text-white transition-all transform hover:scale-105">Shop Now</button>
              </div>
            </div>
            <div className="relative h-[400px] group overflow-hidden bg-white">
              <img 
